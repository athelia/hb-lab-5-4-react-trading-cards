...
ReactDOM.render(
	<TradingCard name="Merge" skill="eating candy" imgUrl="/static/img/merge.jpg" />,
	document.getElementById('merge')
);

ReactDOM.render(
	<TradingCard name="Polymorphism" skill="blending in" imgUrl="/static/img/polymorphism.jpg" />,
